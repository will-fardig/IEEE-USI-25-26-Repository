...
const int LIGHT_THRESHOLD = 50;  // Minimum change to trigger (adjust as needed)

// Variables to track light levels and program state
int currentLight = 0;
int previousLight = 0;
bool programStarted = false;  // Flag to ensure program runs only once
...
void setup() // Definitions of max speed/acceleration, attatchment of servo pins to servor objects, mcp pin setting for solenoids/solenoid driver and forcing solenoid pins to low.
{
    ...
    // Set up photoresistor pin with internal pull-up
    // Note: Using INPUT_PULLUP enables internal ~20-50kΩ pull-up resistor
